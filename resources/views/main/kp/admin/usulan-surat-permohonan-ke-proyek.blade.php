				...
				<table class="table table-bordered table-striped" id="usulan-surat-permohonan-ke-proyek">
					...
					<tbody>
						...
						@foreach ($semua_mahasiswa as $index => $mahasiswa)
							...
							@endphp
							<tr>
								<form action="{{ route('main.kp.admin.usulan-surat-permohonan-ke-proyek.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'accept']) }}" method="post" style="display: inline;" enctype="multipart/form-data">
									...
									<td class="align-middle text-center">
										<a target="_blank" href="{{ route('main.file', ['filename' => $surat_permohonan_ke_proyek->$mhsId->content]) }}" class="text-green">Periksa</a>
									</td>
									<td class="align-middle text-center">
										@csrf
								...
								<td class="align-middle text-center">
									<form action="{{ route('main.kp.admin.usulan-surat-permohonan-ke-proyek.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'decline']) }}" method="post" style="display: inline;" enctype="multipart/form-data">
										@csrf
