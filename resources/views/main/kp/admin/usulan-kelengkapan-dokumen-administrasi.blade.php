...
@section('custom-script')
	<script>
		$("#usulan-kelengkapan-dokumen-administrasi").dataTable();
	</script>
@endsection
	...
	<div class="container">
		<div class="card">
			<div class="card-body" style="overflow-x: auto;">
				<table class="table table-bordered table-striped" id="usulan-kelengkapan-dokumen-administrasi">
					<thead>
						<tr class="bg-green">
					...
					<tbody>
						...
						@foreach ($semua_mahasiswa as $index => $mahasiswa)
							...
							@endphp
							<tr>
								<form action="{{ route('main.kp.admin.usulan-kelengkapan-dokumen-administrasi.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'accept']) }}" method="post" style="display: inline;" enctype="multipart/form-data">
								...
								<td class="align-middle text-center">
									<form action="{{ route('main.kp.admin.usulan-kelengkapan-dokumen-administrasi.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'decline']) }}" method="post" style="display: inline;">
										@csrf
