					...
					<tbody>
						...
						@foreach ($semua_mahasiswa as $index => $mahasiswa)
							...
							<tr>
								...
								<td class="align-middle text-center">
									<form action="{{ route('main.kp.admin.usulan-tga.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'accept']) }}" method="post" style="display: inline;">
										@csrf
										<button type="submit" class="btn btn-sm btn-success">Kirim ke Koor Prodi</button>
									</form>
								</td>
								<td class="align-middle text-center">
									<form action="{{ route('main.kp.admin.usulan-tga.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'decline']) }}" method="post" style="display: inline;">
										@csrf
