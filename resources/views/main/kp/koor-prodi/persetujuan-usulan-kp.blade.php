...
@section('custom-script')
	<script>
		$("#persetujuan-usulan-kp").dataTable();
	</script>
@endsection
	...
	<div class="container">
		<div class="card">
			<div class="card-body" style="overflow-x: auto;">
				<table class="table table-bordered table-striped" id="persetujuan-usulan-kp">
					<thead>
						<tr class="bg-green">
					...
					<tbody>
						...
						@foreach ($semua_mahasiswa as $index => $mahasiswa)
							...
							<tr>
								...
								<td class="align-middle text-center">
									<form action="{{ route('main.kp.koor-prodi.persetujuan-usulan-kp.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'accept']) }}" method="post" style="display: inline;">
										@csrf
										<button type="submit" class="btn btn-sm btn-success">Terima</button>
									</form>
								</td>
								<td class="align-middle text-center">
									<form action="{{ route('main.kp.koor-prodi.persetujuan-usulan-kp.process', ['nim' => $mahasiswa->user->nomor_induk, 'opsi' => 'decline']) }}" method="post" style="display: inline;">
										@csrf
