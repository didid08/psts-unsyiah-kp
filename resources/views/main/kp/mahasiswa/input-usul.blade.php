	...
	<div class="container">
		<div class="card height-auto">
			<div class="card-title text-bold pl-4 pr-4 pt-4" style="font-size: 1.2em;">
				LEMBAR INPUT DATA USULAN KERJA PRAKTEK (KP) MAHASISWA<br>
				PRODI S1 TEKNIK SIPIL - UNSYIAH
			</div>
			<div class="card-body" style="overflow-x: auto;">
				<form action="{{ route('main.kp.mahasiswa.input-usul.process') }}" method="post" enctype="multipart/form-data">
					@csrf
							...
							<table class="table table-bordered table-striped">
								...
								<tbody>
									...
									<tr>
										<td>Judul KP</td>
										<td>
											<textarea name="judul-kp" class="form-control" placeholder="Masukkan Judul KP">{{ $input_value['judul-kp'] != null ? $input_value['judul-kp'] : '' }}</textarea>
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table class="table table-bordered table-striped">
								<tbody>
									...
									<tr>
										<td>Nama Pembahas</td>
										<td colspan="3">
											<input type="text" class="form-control bg-light" value="{{ $input_value['pembahas'] }}" placeholder="Diisi oleh sistem" readonly="readonly">
										</td>
									</tr>
									...
									<tr>
										...
										<td class="align-top text-center">
											...
											<a href="{{ route('main.kp.disposisi') }}" class="btn btn-block btn-secondary">Kembali ke disposisi</a>
