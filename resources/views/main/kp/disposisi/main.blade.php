					...
					<table class="table table-bordered table-striped table-secondary table-responsive">
						...
						<tbody>
							...
							<tr class="{{ background(4, 4, $disposisi) }}">
								<td><b>2</b></td>
								<td colspan="4">
									@include('main.kp.disposisi.'.$folder.'.tahap-2')
								</td>
								<td class="text-center align-middle"></td>
								<td class="text-center align-middle"></td>
								<td class="text-center align-middle"></td>
							...
							<tr class="{{ background(5, 7, $disposisi) }}">
								<td></td>
								<td colspan="4">
							...
							{{-- Tahap 3 --}}
							<tr class="{{ background(8, 9, $disposisi) }}">
								<td><b>3</b></td>
								<td colspan="4">
									@include('main.kp.disposisi.'.$folder.'.tahap-3')
								</td>
								<td class="text-center align-middle">
								</td>
								<td class="text-center align-middle">
							...
							<tr class="{{ background(10, 11, $disposisi) }}">
								<td></td>
								<td colspan="4">
							...
							@if ($disposisi->progress >= 26 &&  $disposisi->progress_optional < 6)
								...
								<tr>
									<td></td>
									<td colspan="4">
										@include('main.kp.disposisi.'.$folder.'.tahap-3-opsional-1')
									</td>
									<td class="text-center align-middle">
								...
								<tr>
									<td></td>
									<td colspan="4">
										@include('main.kp.disposisi.'.$folder.'.tahap-3-opsional-2')
									</td>
									<td class="text-center align-middle">
									</td>
									<td class="text-center align-middle">
